...
export class HttpClient {
  private config: Required<Pick<HttpClientConfig, 'baseUrl' | 'clientId' | 'duplicateSubmitTimeWindowMs' | 'showLoading' | 'maxRetries' | 'retryIntervalMs' | 'timeoutMs' | 'enableHeaderAutoManagement' | 'headerStorageKey' | 'persistManagedHeaders' | 'managedHeadersTtlMs' | 'sendHardwareFingerprint' | 'hardwareFingerprintHeaderName' | 'cryptoExchangePath' | 'protocolVersion'>> & HttpClientConfig;
